  ...
  useEffect(() => {
    ...
    const fetchCustomers = async () => {
      ...
      try {
        ...
        console.error('Error fetching customers for pipeline dropdown:', err);
      } finally {
    ...
    const fetchVendors = async () => {
      ...
      try {
        ...
        console.error('Error fetching vendors for pipeline dropdown:', err);
      } finally {
        setLoadingVendors(false);
      }
    };
    // Fetch users for project manager
