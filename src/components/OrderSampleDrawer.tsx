...
export function OrderSampleDrawer({ 
  ...
  const handleSubmit = async () => {
    try {
      // Create a purchase order from the sample order
      const purchaseOrder = {
        poNumber: '', // Will be auto-generated by server with SAMPLE- prefix
        ...
        total: totalCost,
        priority: '2nd Choice', // Default priority for sample orders
        contact: '', // Can be populated from vendor info later
      ...
      // Send to purchase orders endpoint
