...
export function OrderSampleDrawer({ 
  ...
  const fetchVendorDropShipInfo = async (_vendorName: string) => {
      ...
      {isOpen && (
        <>
          ...
          >
            ...
            {/* Content */}
            <div className="flex-1 overflow-y-auto px-6 py-6 drawer-scroll">
                      ...
                      <div className="grid grid-cols-5 gap-3">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`w-full px-3 py-2 bg-slate-50 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 ${showValidationErrors && (typeof variant.costPerUnit === 'number' ? variant.costPerUnit : (parseFloat(String(variant.costPerUnit)) || 0)) <= 0 ? 'border-red-400 bg-red-50/50' : 'border-slate-200'}`}
                          />
                        </div>
                      </div>
                    </div>
