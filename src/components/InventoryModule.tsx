...
const inventoryItems = [
  ...
  {
    id: 'INV-003',
    name: 'Promotional Notebooks',
    sku: 'NB-STD-003',
    category: 'Office Supplies',
    quantity: 2450,
    minStock: 800,
    unit: 'pcs',
    supplier: 'Paper Plus LLC',
    costPerUnit: '$2.20',
    location: 'Warehouse A',
