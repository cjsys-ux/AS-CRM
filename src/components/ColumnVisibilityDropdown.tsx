...
interface ColumnVisibilityDropdownProps {
  ...
  /** Optional: current column order (array of keys). If not provided, uses columns prop order. */
  columnOrder?: string[];
  /** Optional: callback when column order changes via drag */
...
export function ColumnVisibilityDropdown({ columns, visibleColumns, onChange, columnOrder, onOrderChange, accentColor = 'green' }: ColumnVisibilityDropdownProps) {
  ...
  // Build ordered columns list from draftOrder
