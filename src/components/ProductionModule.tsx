...
const productionOrders = [
  ...
  {
    id: 'PROD-002',
    orderName: 'Water Bottle Production',
    client: 'Fitness Corp',
    ...
    dueDate: '2026-02-20',
    assignedTo: 'Production Line B',
    quality: 99,
  },
  {
    id: 'PROD-003',
    orderName: 'Corporate Gift Assembly',
    ...
    dueDate: '2026-02-28',
    assignedTo: 'Production Line C',
    quality: 0,
  },
  {
    id: 'PROD-004',
    orderName: 'Notebook Printing',
  ...
  {
    id: 'PROD-005',
    orderName: 'Tote Bag Manufacturing',
