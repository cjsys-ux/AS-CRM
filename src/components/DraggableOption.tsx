      ...
      {isEditing ? (
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            className="flex-1 px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
            autoFocus
          ...
          <motion.button
            ...
            className="px-3 py-2 bg-slate-200 text-slate-700 font-semibold rounded-lg hover:bg-slate-300 transition-colors text-sm"
          >
            Cancel
          </motion.button>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3 flex-1">
            <GripVertical className="w-5 h-5 text-slate-400 group-hover:text-blue-500 transition-colors cursor-grab" />
