...
export function ExecutiveOverview() {
  ...
  return (
    <>
      ...
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-lg border border-[#E2E8F0] shadow-sm p-4 mb-6">
        <div className="grid grid-cols-5 divide-x divide-[#E2E8F0]">
          {healthIndicators.map(h => (
            <div key={h.label} className="flex items-center gap-3 px-4 first:pl-0 last:pr-0">
              <div className={`w-3 h-3 rounded-full shrink-0 ${statusColor[h.status]}`} />
              <div className="min-w-0">
                <p className="text-[12px] font-semibold text-[#1E293B] truncate">{h.title}</p>
                <p className="text-[10px] text-[#64748B] truncate">{h.detail}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-lg border border-[#E2E8F0] p-5 shadow-sm">
          <div className="flex items-start justify-between mb-2">
            <div>
              ...
              <h3 className="text-[28px] font-bold text-[#1E293B]">$142,350</h3>
            </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }} className="bg-white rounded-lg border border-[#E2E8F0] p-5 shadow-sm">
          <div className="flex items-start justify-between mb-2">
            <div>
              ...
              <h3 className="text-[28px] font-bold text-[#1E293B]">$583,000</h3>
            </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-white rounded-lg border border-[#E2E8F0] p-5 shadow-sm">
          <div className="flex items-start justify-between mb-2">
            <div>
              ...
              <h3 className="text-[28px] font-bold text-[#1E293B]">34</h3>
            </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }} className="bg-white rounded-lg border border-[#E2E8F0] p-5 shadow-sm">
          <div className="flex items-start justify-between mb-2">
            <div>
              ...
              <h3 className="text-[28px] font-bold text-[#1E293B]">14</h3>
            </div>
      ...
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.55 }} className="bg-white rounded-lg border border-[#E2E8F0] shadow-sm p-4">
        <div className="grid grid-cols-6 divide-x divide-[#E2E8F0]">
          {scorecardItems.map(s => (
            <div key={s.goal} className="px-4 text-center first:pl-0 last:pr-0">
